...
//--------------------- DDR --------------------- */
    ...
    {"UEFI FD",           0x800100000, 0x000200000, AddMem, SYS_MEM, SYS_MEM_CAP, BsCode, WRITE_BACK},
    {"HLOS 0",            0x800300000, 0x000200000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    ...
    {"DXE Heap",          0x800D00000, 0x003300000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    {"HLOS 3",            0x804000000, 0x039200000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    {"Display Reserved",  0x83D200000, 0x000C00000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
    {"HLOS 4",            0x83DE00000, 0x001900000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
